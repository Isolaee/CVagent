...
from cvagent.renderer import render_markdown, render_text, render_to_stdout
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate a customized cover letter using a local LLM via Ollama."
    )
    parser.add_argument(
        "job",
        type=Path,
